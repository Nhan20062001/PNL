                    ...
                    <div className={styles['contact-card-content']}>
                        <div className='container'>
                            ...
                            <div className={styles['contact-form']}>
                                <Form className={styles['form-container']} form={form} name="validateOnly" layout="vertical" autoComplete="off">
                                    ...
                                    <Form.Item name='phone-number' label="Số điện thoại của bạn">
                                        <Input className={styles['input-phone-number']} placeholder='Nhập số điện thoại'/>
                                    </Form.Item>
                                    ...
                                    <Form.Item name="note" label="Để lại lời nhắn của bạn">
                                        <TextArea className={styles['input-note']} placeholder='Viết gì đó cho chúng tôi'/>
                                    </Form.Item>
